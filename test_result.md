...
agent_communication:
    ...
    - agent: "main"
      message: "IMPLEMENTAÇÕES FINAIS CONCLUÍDAS: 1) Município alterado para 'Município Teste' em toda aplicação, 2) Valores do Meu Painel atualizados para fictícios com total R$ 1.250.000 distribuído: FUNDEB R$ 950.000 (76%), PDDE R$ 180.000 (14,4%), PNAE R$ 120.000 (9,6%), execução 69%, disponível 31%, 3) Ícone notificação funcional com dropdown completo: badge com 2 não lidas, 4 notificações (prazo PDDE crítico, repasse FUNDEB confirmado, relatório disponível, documentação pendente), tipos/prioridades/estados. Sistema Aylla 100% funcional para Município Teste."
    - agent: "testing"
